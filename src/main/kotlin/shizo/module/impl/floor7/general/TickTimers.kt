...
import shizo.clickgui.settings.impl.HudElement
...
//Shoutout joy AND Noamm the goats for figuring this out ily
@AlwaysActive
object TickTimers : Module(
    ...
    private val startTimer by BooleanSetting(
        "Start timer",
        false,
    ...
    private fun formatTimer(time: Int, max: Int, prefix: String): String {
        ...
        return "$prefix $color$timeDisplay"// u are very silly cubey
    }
}