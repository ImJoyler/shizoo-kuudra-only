...
import shizo.utils.renderUtils.renderUtils.drawFilledBox
...
object ArrowsDevice : Module(
    ...
    init {
        ...
        onReceive<ClientboundSetEntityDataPacket> {
            ...
            //todo maybe this is what resets the i4 device early, if it happens on 1.21.10 too ill work on it

            if (mc.level?.getEntity(this.id)?.name?.string == "Active") onComplete("Entity")
        }
    }
