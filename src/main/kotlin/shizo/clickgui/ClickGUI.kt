...
import shizo.utils.clickgui.mouseX as odinMouseX // might change but who cares
...
object ClickGUI : Screen(Component.literal("Click GUI")) {
    ...
    override fun init() {
        println("Regeistering this init")
        openAnim.start()
        super.init()
    }
    ...
    val movementImage by lazy { NVGRenderer.createImage("/assets/shizo/MovementIcon.svg") }
    val hueImage by lazy { NVGRenderer.createImage("/assets/shizo/HueGradient.png")}
    val chevronImage by lazy { NVGRenderer.createImage("/assets/shizo/chevron.svg")}
