...
//import shizo.module.impl.dungeon.dungeonwaypoints.DungeonWaypoints.DungeonWaypoint
...
//
//    private val configFile = File(mc.gameDirectory, "config/shizo/dungeon-waypoint-config.json").apply {
//        try {
//            parentFile?.mkdirs()
//            createNewFile()
//        } catch (_: Exception) {
